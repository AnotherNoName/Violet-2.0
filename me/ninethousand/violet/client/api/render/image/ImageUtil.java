...
import me.ninethousand.violet.client.api.render.image.TextureManagerUtil;
...
public class ImageUtil {
    ...
    public static EfficientTexture cacheBufferedImage(BufferedImage image, String format, String name) throws NoSuchAlgorithmException, IOException {
        ...
        ResourceLocation location = TextureManagerUtil.getEfficientTextureResourceLocation(Constants.mc.getTextureManager(), name, texture);
        Constants.mc.getTextureManager().loadTexture(location, (ITextureObject)texture);
        return texture;
    }
    ...
    public static void bindImage(BufferedImage bufferedImage) throws IOException, NoSuchAlgorithmException {
        ...
        ResourceLocation location = Constants.mc.getTextureManager().getDynamicTextureLocation(name, texture);
        Constants.mc.getTextureManager().bindTexture(location);
    }
